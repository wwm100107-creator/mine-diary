              ...
              <div className={s.chatHeader}>
                <div className={s.chatHeaderLeft}>
                  ...
                  {(() => {
                    ...
                    const isWideUser = ['god_cosmic', 'vip10_thunder', 'vip9_frost', 'vip8_fire', 'cyber_aura', 'sakura_hearts', 'emerald_royal', 'sazabi_verka', 'gundam_calibarn', 'unicorn_awakened', 'wing_zero_ew'].includes(userFrame)
                    const isWidePartner = ['god_cosmic', 'vip10_thunder', 'vip9_frost', 'vip8_fire', 'cyber_aura', 'sakura_hearts', 'emerald_royal', 'sazabi_verka', 'gundam_calibarn', 'unicorn_awakened', 'wing_zero_ew'].includes(partnerFrame)
